...
//        System.out.println(basicCalculator(1, '/', 0));
        ...
        System.out.println(extendedCalculator("6 - 5"));
        System.out.println(extendedCalculator("2 + 4"));
        System.out.println(extendedCalculator("12 / 3"));
        System.out.println(extendedCalculator("3 * 4 "));
        System.out.println(extendedCalculator("1 / 0"));
        System.out.println(extendedCalculator("1 x 0"));
    ...
    public static Double extendedCalculator(String s) {
